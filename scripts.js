...
document.querySelector('.form-box.login form').addEventListener('submit', (e) => {
    ...
    const validEmails = ["Youssef@pi.m", "Youssra@pi.m", "Aya@pi.m","Bouchlaghem@pi.m","Lamnii@pi.m","Oudghiri@pi.m","Anass@pi.m","Ziane@pi.m","Mermri@pi.m","Tsouli@pi.m","Loubna@pi.m","Serji@pi.m","Jaara@pi.m"];
